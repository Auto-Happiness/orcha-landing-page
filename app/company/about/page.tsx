  ...
  const timelineData = [
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="mb-8 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
            Dedicated our efforts to researching and developing cutting-edge AI orchestration technologies.
          </p>
          <p className="mb-8 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
            Our team of experts worked tirelessly to create a platform that would revolutionize how businesses interact with AI technologies.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
              src="/features/deployment.jpg"
        ...
        <div>
          ...
          <div className="mb-8">
            <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
              ✅ Launched AI Orchestration Platform
            </div>
            <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
