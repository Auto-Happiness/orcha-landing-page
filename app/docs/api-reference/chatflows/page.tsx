...
import { Workflow, ArrowLeft, ArrowRight } from "lucide-react";
import DocsSidebar from "@/components/docnav/DocumentNavigation";
import navItems from "@/data/document-nav.json";
import QuickLinks from "@/components/quicklinks/QuickLinks";
import quickLinks from "@/data/quicklinks/chatflows.json";
import Link from "next/link";

export default function ChatflowsApiPage() {
  return (
        ...
        <div className="flex-1 px-6 py-10 pt-24 max-w-5xl">
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <Badge variant="outline" className="border-orange-500/30 text-orange-300">Chatflows</Badge>
            </div>
            <h1 className="text-4xl font-bold mb-4">Chatflows API</h1>
            <p className="text-lg text-gray-400">
              Manage chatflow configurations and deployments.
            </p>
          </div>
            ...
            <Card className="bg-gray-900/50 border-gray-800">
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <CardTitle className="text-xl text-white">Create chatflow</CardTitle>
                </div>
                <CardDescription className="text-gray-400">Create a new chatflow configuration</CardDescription>
              </CardHeader>
  ...
  "apikey": "api_xxxxxxxx"
                ...
                <div>
                  ...
                  <div className="bg-gray-950 border border-gray-800 rounded-lg p-4">
                    <pre className="text-sm font-mono text-gray-300">
{`{
  "id": "chat_7db93c028d5a41178f13dfb6721b339",
  "name": "Customer Support Flow",
  "description": "AI-powered customer support",
  "deployed": true,
  "isPublic": false,
            ...
            <Card className="bg-gray-900/50 border-gray-800">
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <CardTitle className="text-xl text-white">Get chatflow</CardTitle>
                </div>
                <CardDescription className="text-gray-400">Retrieve chatflow details</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
            ...
            <Card className="bg-gray-900/50 border-gray-800">
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <CardTitle className="text-xl text-white">Update chatflow</CardTitle>
                </div>
                <CardDescription className="text-gray-400">Update chatflow configuration</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
            ...
            <Card className="bg-gray-900/50 border-gray-800">
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <CardTitle className="text-xl text-white">Delete chatflow</CardTitle>
                </div>
                <CardDescription className="text-gray-400">Delete a chatflow</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
